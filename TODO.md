...
## ⭐ 要你定:三条开着的 PR + 一条 tier-C(2026-09-04)

自动化这一轮**只解决了「重复劳动」那类**。下面四件都是**真的要人**,不是漏做的自动化 ——
每条都写了它卡在哪一个条件上,判完就删。

- [ ] ⭐ **PR #105 / #109**(8-23、8-25 开):四条件**全真**,CI 当时就是 success,只是被旧章程的
      「默认开 PR」拦着(章程已改,见 `LOG.md` 2026-09-04)。⇒ **合并即可**,内容是把 charxiv /
      mrcr / browsecomp 三条死路的 verdict 写进 §9,防止下一班重新推导一遍。
...
- [ ] ⭐ **issue #122 / 每日 drift job 自 9-03 起红**:LiveBench 在**冻结的 2026-06-25** 版本下把
