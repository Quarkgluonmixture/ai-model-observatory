...
export const featured: Featured[] = [
  ...
  },
  {
    ...
    ringPct: 47.5,
    meters: [
      { label: "模型家族 × benchmark", value: "28 × 68", pct: 0 },
      { label: "已填充 / 总格数", value: "919 / 1904", pct: 48.3, tone: "a" },
    ],
    points: [
      "1,224 条观测,每条都带来源、版本、日期和 harness,能一路查回去。目录里的数字有 99% 能对上源归档(310 / 313)。",
